...
export const metadata: Metadata = { title: "Fragrance Resources", description: "Practical fragrance development resources and common questions for product teams.", alternates: { canonical: "/resources" } };
