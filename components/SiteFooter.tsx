...
export function SiteFooter() {
  return (
    <footer className="footer">
      ...
      <div><h3>Resources</h3><Link href="/applications">Applications</Link><Link href="/products">Products</Link><Link href="/news">News & Insights</Link><Link href="/resources">Fragrance Library</Link><Link href="/resources/faq">FAQs</Link></div>
