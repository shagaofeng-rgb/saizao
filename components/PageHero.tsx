...
export function PageHero({ eyebrow, title, intro, image, cta = true }: { eyebrow: string; title: string; intro: string; image: string; cta?: boolean }) {
  return (
    <section className="page-hero page-hero-animated">
      ...
      <div className="page-hero-image"><Image src={image} alt="Sai Zhao fragrance development" fill priority sizes="(max-width: 800px) 100vw, 48vw" className="cover-image page-hero-photo" /></div>
    </section>
  );
}
